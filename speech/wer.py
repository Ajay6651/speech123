...
MODEL_DIR = "c:/Users/akjb2/Downloads/vosk-model-small-en-us-0.15 (2)/vosk-model-small-en-us-0.15"
...
while time.time() - start_time < 60:  # Listen for 10 seconds for demonstration purposes
    ...
    if recognizer.AcceptWaveform(data):
        ...
        reference_text = "The world is so beautiful with happiness and makes love with every animals"  # Provide the actual spoken words
